...
<form class="lead-form" data-lead-form data-step="1" novalidate>
	<div class="lead-form__frame">
		<div class="lead-form__progress" aria-hidden="true">
			<span class="lead-form__progress-seg is-current" data-lead-progress="1"></span>
			<span class="lead-form__progress-seg" data-lead-progress="2"></span>
		</div>

		<div class="lead-form__steps" data-lead-steps>
			<div class="lead-form__step is-active" data-lead-step="1">
				<p class="lead-form__step-label"><?php esc_html_e( 'Крок 1 з 2', 'messcut' ); ?></p>
				<div class="lead-form__field">
					<label for="lead-name"><?php esc_html_e( 'Імʼя', 'messcut' ); ?> *</label>
					<input id="lead-name" name="name" type="text" required autocomplete="name" placeholder="<?php esc_attr_e( 'Як до вас звертатися', 'messcut' ); ?>">
				</div>
				...
				<button class="button button--primary lead-form__action" type="button" data-lead-next><?php esc_html_e( 'Далі', 'messcut' ); ?></button>
			</div>

			<div class="lead-form__step" data-lead-step="2" hidden>
				<p class="lead-form__step-label"><?php esc_html_e( 'Крок 2 з 2', 'messcut' ); ?></p>
				<div class="lead-form__field">
				...
				<div class="lead-form__nav">
					...
					<button class="button button--accent lead-form__action" type="submit"><?php esc_html_e( 'Надіслати', 'messcut' ); ?></button>
				</div>
			</div>
